...
function JoinItem(props) {
  return <div className="col-md-3 p-t-30">
      ...
      <div className="content-intro bg3 p-t-77 p-b-40 ">
        <div className="container">
          <div className="row">
            ...
            <JoinItem icon={'fa-location-arrow'} title={'Active community of reviews with over 2000+ new monthly reviews'}/>
            <JoinItem icon={'fa fa-shopping-bag'} title={'highest ROI Rate, highest click rate'}/>
            <JoinItem icon={'fa fa-microphone'} title={'create your business profile for strong Brand Building'}/>
            <JoinItem icon={'fa fa-bullhorn'} title={'active blog with contributions from top professionals in the industry'}/>
            ...
            <JoinItem icon={'fa-location-arrow'} title={'take off with more exposure and book More Reservations'}/>
