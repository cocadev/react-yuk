        ...
        <section className="section-slide">
          <div className="wrap-slick1">
            <div className="slick1">
              <div className='item-slick1 item1-slick1' style={{ backgroundImage: `url('images/back1.jpg')` }}>
                <div className="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">

                  <h4 className="caption2-slide1 tit1 t-center animated visible-false m-b-37" data-appear="fadeInUp">
                    YuKai is ready for building One page Website
						      </h4>

                  <span className="caption1-slide1 txt1 t-center animated visible-false m-b-30" data-appear="fadeInDown">
                  ...
                  <div className="bgwhite p-20 flex-c" >
                    ...
                    <div className="landingBTN c-brown tt-up fs-8 flex-l f-weight">
                      select a category
                      <i className="fas fa-angle-down c-blue fs-11 m-l-30" aria-hidden="true"></i>
                    </div>
                    <div className="landingBTN c-brown tt-up fs-8 flex-l f-weight">
                      select a location
                      <i className="fas fa-angle-down c-blue fs-11 m-l-30" aria-hidden="true"></i>
                  ...
                  <div className="flex-c m-t-30">
                    <div className='landingIcon'>
                      <i className="fas fa-hotel c-white fs-20" aria-hidden="true"></i>
                      <div className='c-white fs-8 m-t-3'>HOTEL</div>
                    </div>
                    <div className='landingIcon'>
                      <i className="fas fa-coffee c-white fs-20" aria-hidden="true"></i>
                      <div className='c-white fs-8 m-t-3'>RESTAURANTS</div>
                    </div>
                    <div className='landingIcon'>
                      <i className="fas fa-store c-white fs-20" aria-hidden="true"></i>
                      <div className='c-white fs-8 m-t-3'>SHOPPING</div>
                    </div>
                    <div className='landingIcon'>
                      <i className="fas fa-warehouse c-white fs-20" aria-hidden="true"></i>
